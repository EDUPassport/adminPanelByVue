...
<script>
import {  approveJobs, delJobs, setJobFeature, refreshJobs,userJobList } from '@/api/jobs'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.listQuery.user_id = this.$route.query.uid

      userJobList(this.listQuery).then(response => {
