<template>
  <div class="app-container">
    <div class="filter-container">
      <el-select v-model="listQuery.feature" placeholder="Feature" clearable class="filter-item" @clear="handleClear()">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="top">
        ...
        <el-form-item :label="dynamic_title" prop="featureable_id">
          <el-select v-model="temp.featureable_id" filterable remote reserve-keyword class="filter-item"
            placeholder="Please select" @change="handleFeatureTypeChange">
